import { SmartContractLib, method, prop, assert, SmartContract } from "scrypt-ts"
...
export class FPTest extends SmartContract{
    ...
    @method()
    public unlock(precision : bigint, x : bigint, y : bigint, op : bigint, r : bigint) {
        
      let fp : FixedPoint = new FixedPoint(precision);
