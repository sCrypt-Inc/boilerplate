import { ByteString, PubKeyHash, SmartContract, Utils, assert, hash160, hash256, method, prop } from "scrypt-ts";

export class P2SH extends SmartContract{
    @prop()
    scripthash : PubKeyHash

    constructor(scripthash : PubKeyHash){
        super(...arguments)
