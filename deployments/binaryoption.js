...
(async() => {
    try {
        ...
        let betPrice = 100
        //let rabinPubKey = 0x15525796ddab817a3c54c4bea4ef564f090c5909b36818c1c13b9e674cf524aa3387a408f9b63c0d88d11a76471f9f2c3f29c47a637aa60bf5e120d1f5a65221n
        ...
        console.log("pubkeyhash: ", toHex(bsv.crypto.Hash.sha256ripemd160(publicKeyA.toBuffer())), toHex(bsv.crypto.Hash.sha256ripemd160(publicKeyB.toBuffer())))
        ...
        //let lockingTxid = '82d1f53d80c05bdc4617c8d5e857a12807d61551d863eae20172beb55f034fae'
        ...
        console.log('scriptCode:', input.script.toHex())
        console.log('prevLockingScript:', binaryOption.lockingScript.toHex())
        console.log('unlockingScript:', unlockingScript.toHex())
        console.log('unlockingScript ASM:', unlockingScript.toASM())
